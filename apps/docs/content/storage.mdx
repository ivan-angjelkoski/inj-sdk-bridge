...
```ts
import { LocalStorageRepository } from "@injectivelabs/cctp-bridge";
...
```ts
import { MemoryStorageRepository } from "@injectivelabs/cctp-bridge";
...
```ts
import type { StorageRepository, BridgeState } from "@injectivelabs/cctp-bridge";
